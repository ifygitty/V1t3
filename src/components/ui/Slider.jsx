  ...
  const renderThumb = (value) => {
    const thumb = (
      <SliderPrimitive.Thumb
        ...
        className="border-[1.65px] border-primary bg-background ring-ring/50 block size-3 shrink-0 rounded-full shadow-sm transition-[color,box-shadow] outline-none hover:ring-4 focus-visible:ring-4 disabled:pointer-events-none disabled:opacity-50"
