...
const Banner3form = ({className}) => {
  return (
    <div className={cn(`bg-white/60 shadow-md rounded-lg text-center  p-4 w-[427px] max-w-md mx-auto `, className)}>
            ...
            <form className="mt-5 flex items-center bg-white p-3 rounded-md overflow-hidden">
                <input
                type="email"
                ...
                <button
                type="submit"
                className="bg-[#5C4033] hover:bg-[#4a3228] text-white font-medium px-5 py-2 transition-colors"
                >
                Subscribe
                </button>
            </form>
